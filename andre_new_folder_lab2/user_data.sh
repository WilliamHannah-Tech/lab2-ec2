...
<body>
    <div class="container">
        <h1>About Me: Andre's Chick Magnet</h1>
        <h2>Description:Driving to Dre's Boom Boom Room - AWS Instance Metadata</h2>
        
        <img src="https://www.bentleymotors.com/content/dam/bm/websites/bmcom/bentleymotors-com/models/26my/26my-gtc-azure/Range%20Stage%20Main.jpg/_jcr_content/renditions/original.image_file.1824.782.file/Range%20Stage%20Main.jpg" alt="Lizzo" class="hero-image">
